...
function _getDestTypeFromMethod(method) {
  ...
  if(['is_ready', 'get_reflected_host_info', 'is_chat_handle_in_use',
      ...
      'get_escrowed_balances', 'autobtcescrow_get_escrow_address', 'autobtcescrow_get_btc_escrowed_balances',
      'autobtcescrow_get_by_order_signed_tx_hashes'].indexOf(method) >= 0) {
